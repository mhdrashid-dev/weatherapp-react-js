  ...
  return (
    <section className='starter w-full h-screen bg-primary flex flex-col items-center py-10'>
      <div className="content font-montserrat text-center my-auto  mb-20">
        ...
        <button className='bg-purple-600 text-white text-sm px-5 py-2 md:px-8 md:py-3 md:text-xl rounded mt-16 duration-700 active:scale-x-110' onClick={LoadWeatherPage}>Get Started</button>
      </div>
